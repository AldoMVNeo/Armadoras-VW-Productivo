...
<html>
   ...
   <%-- Encabezado de Pagina  --%>
     <table width="100%" border="0" cellspacing="0" cellpadding="30">
        ...
        <td>       
        <div class=\"bigText\">
              <img src="<%=util.getContexto(request)%>/neology/recursos/imagenes/usuarios.gif" border="0" width="112" height="79" align="absmiddle"/><bean:message key="texto.etiqueta.sistema.cambiarUsuario" />
        </div> 
        <hr />
        </td> 
        </tr>
  ...
  <%-- Fin de Encabezado --%>  
        ...
        <html:form action="/cambiarNombreUsuario.do" onsubmit="return false">
            ...
            <div align="center">
                <br>
                 <input type="button"  onclick="submit('cambiarNombreUsuarioForm');" class="submit" value="<bean:message key="boton.regresar"/>" ></input>
            </div>
        </html:form>
    </body>
</html>
