...
<html>
    <head>
       ...
       <script src="<%=util.getContexto(request)%>/neology/javascript/arbol/dhtmlxtree.js" type="text/javascript" language="Javascript"></script>
        <title><bean:message key="texto.etiqueta.perfil.alta"/></title>
    </head>
    ...
    <%-- Encabezado de Pagina  --%>
     <table width="100%" border="0" cellspacing="0" cellpadding="30">
        ...
        <td>       
        <div class=\"bigText\">
              <img src="<%=util.getContexto(request)%>/neology/recursos/imagenes/perfiles.gif" border="0" width="112" height="79" align="absmiddle"/><bean:message key="texto.etiqueta.perfil.alta"/>
        </div> 
        <hr />
        </td> 
        </tr>
  ...
  <%-- Fin de Encabezado --%>  
        <html:form action="/permisosUsuario.do?do=agregarPerfil" onsubmit="agregarPerfil();" >
           <html:hidden property="do" value="agregarPerfil"/>          
    ...
    <%-- Fin Mensajes de Error --%>  
					...
					<td align="left" height="100%">
						<table width="100%" height="100%" border="0" cellspacing="1" cellpadding="8">
							...
							<tr>
								<td align="left">
									<div id="treeboxbox_tree2" style="width:100%; height:405px;overflow:scroll;"></div>
								</td>
							</tr>
						</table>
					</td>
...
tree2.loadXML("/armadoras/neology/paginas/catalogos/permisos/PermisoAlta.xml");
