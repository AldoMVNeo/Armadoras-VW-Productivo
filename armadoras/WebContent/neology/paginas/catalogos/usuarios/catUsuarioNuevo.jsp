...
<html>
    <head>
    	...
    	<script src="<%=util.getContexto(request)%>/neology/javascript/utilidades/utilidades.js" type="text/javascript" language="Javascript"></script>
  ...
  <%-- Fin de Encabezado --%>  
          ...
          <td align="left">         
            <html:select property="idPerfil" name="usuariosForm" styleClass="textfield">
              <html:option value="-1"> <bean:message key="combo.opcion.seleccionar"/></html:option>
        ...
        <tr class="row2">
                ...
                <tr class="row2">
                    ...
                    <td align="left">
                        <html:text styleClass="textfield" name="usuariosForm" maxlength="6" property="usuario" onkeypress="return isAlphanumericKeys(event)"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    <strong><bean:message key="texto.etiqueta.usuario.contrasena"/>:</strong>            
                    </td>
                    <td align="left">
                        
                        <html:password styleClass="textfield" name="usuariosForm" maxlength="10" property="contrasena" onkeypress="return isAlphanumericKeys(event)"></html:password>
                    </td>
                </tr>
                <tr>
                <html:hidden styleClass="textfield" name="usuariosForm"  property="estatus" value="0"/>
        <td colspan="2" align="center">
          <html:submit styleClass="submit"><bean:message key="boton.alta"/></html:submit>
