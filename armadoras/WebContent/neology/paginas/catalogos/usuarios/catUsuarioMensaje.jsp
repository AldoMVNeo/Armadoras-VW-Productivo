...
@import "<%=util.getContexto(request)%>/neology/estilos/tablaFiltro.css";
  ...
  <%-- Fin de Encabezado --%>  
        ...
        <html:form action="/usuarios.do" onsubmit="return false">
            ...
            <div align="center">
                <br>
                 <input type="button"  onclick="submit('usuariosForm');" class="submit" value="<bean:message key="boton.regresar"/>" ></input>
            </div>
        </html:form>
    </body>
</html>
