...
@import "<%=util.getContexto(request)%>/neology/estilos/tablaFiltro.css";
    ...
    <%-- Encabezado de Pagina 
        ...
        <html:form action="/entidades.do" onsubmit="return false">
            ...
            <div align="center">
                <br>
                 <input type="button"  onclick="submit('entidadesForm');" class="submit" value="<bean:message key="boton.regresar"/>" ></input>
            </div>
        </html:form>
    </body>
</html>
