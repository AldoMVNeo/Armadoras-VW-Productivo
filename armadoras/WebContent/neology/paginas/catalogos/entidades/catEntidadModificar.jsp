...
<html>
    ...
    <body class="bodyContent">
        <html:form action="/entidades2.do" >
        ...
        <hr />
             ...
             <table width="100%" border="0" cellspacing="1" cellpadding="5">
                 <tr class="row2">
                    ...
                    <td align="left">
                        <html:text styleClass="textfield" name="entidadesForm" maxlength="20" property="nombreEntidad" onkeypress="return isAlphanumeric(event)"/>
                    </td>
                </tr>                                                                
                <tr>
