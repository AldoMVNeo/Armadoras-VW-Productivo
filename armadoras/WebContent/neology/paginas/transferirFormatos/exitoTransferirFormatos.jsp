...
<%-- Fin Estilo para tabla --%>
        <title>
            <bean:message key="texto.etiqueta.transferirFormatos.titulo"/>
        </title>
    </head>
    <body class="bodyContent">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="30">
	    ...
	    <%-- Fin de Encabezado --%> 
        <html:form action="/transferirFormatos.do" onsubmit="return false">
            ...
            <DIV align="center">
             ...
             <div align="center">
        <br>
           <input type="button"  onclick="submit('transferirFormatosForm');" class="submit" value="<bean:message key="boton.regresar"/>" ></input>
        </div>
        </html:form>
    </body>
</html>
