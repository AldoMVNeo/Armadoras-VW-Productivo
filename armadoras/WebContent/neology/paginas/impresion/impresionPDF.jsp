...
<title><bean:message key="texto.emision.imprimirCI"/></title>
	...
	<%-- Encabezado de Pagina  --%>
     <table width="100%" border="0" cellspacing="0" cellpadding="30">
        ...
        <td>       
        <div class=\"bigText\">
              <img src="<%=util.getContexto(request)%>/neology/recursos/imagenes/imprimirFormatos.gif" border="0"  align="absmiddle"/><bean:message key="texto.emision.imprimirCI"/>
        </div> 
        <hr />
        </td> 
        </tr>
  ...
  <%-- Fin de Encabezado --%>  
		<html:form action="/impresiones.do" > 
			<html:hidden property="do" value="listar"/>	
...
document.body.onload = function(){mostrarReporteTP("<%=util.getContexto(request)%>")}; 
</script>
