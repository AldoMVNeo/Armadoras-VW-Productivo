...
public class HiddenApplet extends JApplet
{
	...
	private static final long serialVersionUID = -4086974569218802844L;
	...
	private ArrayList<String[]> m_paramter_info = new ArrayList<String[]>();
		...
		if (id != null)
		{
			JSObject.getWindow(this).eval(
					"var applet = document.getElementById( '" + id + "' );"
							+ "if( applet ) "
							+ "{ applet.style.width='0'; applet.style.height='0'; }");
		}
		this.resize(0, 0);
	}
